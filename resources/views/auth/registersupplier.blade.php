    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                @endif
                <div class="card-header"><h3>{{ __('Register Supplier') }}</h3></div>

                <div class="card-body">
                    <form method="POST" action="/postregistersupplier" enctype="multipart/form-data" name="form" onsubmit="return validateForm()">
                        @csrf
