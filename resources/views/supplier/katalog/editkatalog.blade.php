                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ url('/supplier/katalog/katalog') }}/{{ $katalogs->id }}" enctype="multipart/form-data" name="form" onsubmit="return validateForm()">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="kategori_katalog" id="kategori_katalog" class="form-control @error('kategori_katalog') is-invalid @enderror" value="{{ $katalogs->kategori_katalog }}" autocomplete="kategori_katalog" autofocus>
