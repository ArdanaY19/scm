                ...
                <div class="card">
                    <div class="card-header">
                        <h1 class="row d-flex align-items-center">
                            ...
                            <a class="col-md-2" href="/supplier/profile/edit/{{auth()->user()->supplier->id}}" style="font-size: 20px;"><i class="fa fa-cog mr4"></i> Edit Profile</a>
                        </h1>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <h2 class="text-uppercase">{{auth()->user()->supplier->nama}}</h2>
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            <td><i class="fa fa-birthday-cake"></i> Tanggal Lahir</td>
                                            <td>:</td>
                                            <td>{{auth()->user()->supplier->tanggal_lahir}}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td class="text-capitalize">{{auth()->user()->supplier->alamat}}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            <div class="col-md-6">
                                <img src="{{ url('foto') }}/{{ auth()->user()->supplier->foto }}" class="rounded mx-auto d-block" width="350" alt="">
                            </div>
                        </div>
                    </div>
                </div>
