                ...
                <div class="col-md-12 mt-4">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Buat Kamar</li>
                        </ol>
                    </nav>
                </div>
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/manager/kamar/kamar" enctype="multipart/form-data" name="form" onsubmit="return validateForm()">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="booking" id="booking" class="form-control @error('booking') is-invalid @enderror" value="{{ old('booking') }}" autocomplete="booking" autofocus>
                                @error('booking')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group">
                                ...
                                <input id="gbrkamar" type="file" class="form-control @error('gbrkamar') is-invalid @enderror" name="gbrkamar" value="{{ old('gbrkamar') }}" autocomplete="gbrkamar" autofocus>
                                @error('gbrkamar')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
