        ...
        <div class="col-md-12 mt-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/customer/profile/profile/{{auth()->user()->customer->id}}">Profile</a></li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form action="/customer/profile/update/{{auth()->user()->customer->id}}" method="post" enctype="multipart/form-data" name="form" onsubmit="return validateForm()">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group mt-2">
                                        <img src="{{asset('foto/'.auth()->user()->customer->foto)}}" width="50%" alt="">
                                    </div>
                                </div>
                                
                                <div class="form-group mt-3">
                                    <a href="/customer/profile/profile/{{auth()->user()->customer->id}}" class="btn btn-danger">Batal</a>
